...
class GoogleAppsSaGroupRemoveUsersV1
  ...
  def execute()
    ...
    for user in remove_list
      ...
      puts "Successfully deleted '#{user}' from the group" if @enable_debug_logging
    end
