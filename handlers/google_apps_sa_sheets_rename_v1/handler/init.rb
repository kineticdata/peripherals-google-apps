...
class GoogleAppsSaSheetsRenameV1
  ...
  def execute()
    ...
    method = sheets.spreadsheets.batch_update
    ...
    puts "Rename spreadsheet to the name '#{@parameters["new_name"]}'" if @enable_debug_logging
    result = client.execute(
      :api_method => method,
      :body => data.to_json,
      :parameters => {'spreadsheetId' => @parameters['sheet_id']},
